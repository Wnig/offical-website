<template>
    <div class="template-02">
      <ItemBlock02 ref="itemBlock02"></ItemBlock02>
      <ItemIntro03 ref="itemIntro03"></ItemIntro03>
      <ItemIntro04 ref="itemIntro04"></ItemIntro04>
      <ItemIntro05 ref="itemIntro05"></ItemIntro05>
      <ItemIntro06 ref="itemIntro06"></ItemIntro06>
      <ItemIntro07 ref="itemIntro07"></ItemIntro07>
    </div>
  </template>
